...
// recover boundary, panics reboot the node, no shell ever." Boot is
// fail-closed: any subsystem failure during bring-up calls reboot(2)
// rather than continuing with a degraded state.
package init
